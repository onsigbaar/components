...
use Onsigbaar\Components\Exceptions\InvalidAssetPath;
use Onsigbaar\Components\Exceptions\ModuleNotFoundException;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Onsigbaar\Components\Exceptions\ModuleNotFoundException
     */
