...
class MigrationMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->artisan('component:make-migration', ['name' => 'create_posts_table', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-migration', ['name' => 'add_something_to_posts_table', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-migration', ['name' => 'delete_something_from_posts_table', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-migration', ['name' => 'drop_posts_table', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-migration', ['name' => 'something_random_name', 'module' => 'Blog']);
