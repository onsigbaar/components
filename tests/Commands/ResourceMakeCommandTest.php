...
class ResourceMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->artisan('component:make-resource', ['name' => 'PostsTransformer', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-resource', ['name' => 'PostsTransformer', 'module' => 'Blog', '--collection' => true]);
