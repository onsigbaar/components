...
class ProviderMakeCommandTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->artisan('component:make', ['name' => ['Blog'], '--plain' => true, ]);
    }
    ...
    {
        $this->artisan('component:make-provider', ['name' => 'MyBlogServiceProvider', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-provider', ['name' => 'BlogServiceProvider', 'module' => 'Blog', '--master' => true]);
