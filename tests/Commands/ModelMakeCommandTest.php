...
class ModelMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->artisan('component:make-model', ['model' => 'Post', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-model', ['model' => 'Post', 'module' => 'Blog', '--fillable' => 'title,slug']);
    ...
    {
        $this->artisan('component:make-model', ['model' => 'Post', 'module' => 'Blog', '--migration' => true]);
    ...
    {
        $this->artisan('component:make-model', ['model' => 'Post', 'module' => 'Blog', '-m' => true]);
    ...
    {
        $this->artisan('component:make-model', ['model' => 'ProductDetail', 'module' => 'Blog', '-m' => true]);
