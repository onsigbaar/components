...
class CommandMakeCommandTest extends BaseTestCase
{
    ...
    {
        $this->artisan('component:make-command', ['name' => 'MyAwesomeCommand', 'module' => 'Blog']);
    ...
    {
        $this->artisan('component:make-command', ['name' => 'MyAwesomeCommand', 'module' => 'Blog', '--command' => 'my:awesome']);
    ...
    public function it_can_change_the_default_namespace()
    {
        ...
        $this->artisan('component:make-command', ['name' => 'AwesomeCommand', 'module' => 'Blog']);
